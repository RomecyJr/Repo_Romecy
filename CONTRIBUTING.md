...
Obrigado por contribuir! Este documento define como trabalhamos neste
monorepo.
...
- Cada projeto fica em `projetos/<nome>` com `README.md`, `Dockerfile`,
  `compose.yml` (se houver) e `tests/`.
